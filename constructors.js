...
function Employee(name, email, hireDate) {
  ...
  */
  ...
  User.prototype.removeSavedPost = function(id){
    const remove = this.savedPosts.findIndex( (obj2) => {
      return obj2.id === id
    })
  ...
  User.prototype.changePostRating = function (id, rating){
    const update = this.savedPosts.findIndex( (obj3) => {
      return obj3.id == id
    })
    this.savedPosts[update].rating = rating
  }